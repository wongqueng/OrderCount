...
local Scanner = OC.Init("Service.ProfessionHelpers.Scanner") ---@class Service.ProfessionHelpers.Scanner
local Environment = OC.Include("Environment")
local State = OC.Include("Service.ProfessionHelpers.State")
...
function private.ScanProfession()
	...
	if Environment.HasFeature(Environment.FEATURES.C_TRADE_SKILL_UI) then
		...
		for index, spellId in ipairs(recipes) do
			...
			-- TODO: show unlearned recipes in the OC UI
