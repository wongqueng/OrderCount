...
local TooltipScanning = OC.Init("Service.TooltipScanning") ---@class Service.TooltipScanning
...
function private.PrepareTooltip()
	...
	private.tooltip = private.tooltip or CreateFrame("GameTooltip", "OCScanTooltip", UIParent, "GameTooltipTemplate")
...
function private.TooltipLineIteratorHelper(info, index)
	while true do
		...
		if Environment.HasFeature(Environment.FEATURES.C_TOOLTIP_INFO) then
			...
			local tooltipText = _G["OCScanTooltipTextLeft"..index]
