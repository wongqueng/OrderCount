...
local Threading = OC.Init("Service.Threading") ---@class Service.Threading
...
local ErrorHandler = OC.Include("Service.ErrorHandler")
local Thread = OC.Include("LibOCClass").DefineClass("Thread")
local private = {
	threads = {},
	queue = {},
	runningThread = nil,
