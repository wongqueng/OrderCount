...
local Query = OC.Init("Service.AuctionScanClasses.Query") ---@class Service.AuctionScanClasses.Query
...
local Scanner = OC.Include("Service.AuctionScanClasses.Scanner")
local LibOCClass = OC.Include("LibOCClass")
local AuctionQuery = LibOCClass.DefineClass("AuctionQuery")
local private = {
