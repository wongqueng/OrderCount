...
local ScanManager = OC.Init("Service.AuctionScanClasses.ScanManager") ---@class Service.AuctionScanClasses.ScanManager
...
local Query = OC.Include("Service.AuctionScanClasses.Query")
local QueryUtil = OC.Include("Service.AuctionScanClasses.QueryUtil")
local AuctionScanManager = OC.Include("LibOCClass").DefineClass("AuctionScanManager")
local private = {
