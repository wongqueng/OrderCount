...
local ResultRow = OC.Init("Service.AuctionScanClasses.ResultRow") ---@class Service.AuctionScanClasses.ResultRow
...
local Util = OC.Include("Service.AuctionScanClasses.Util")
local AuctionHouseWrapper = OC.Include("Service.AuctionHouseWrapper")
local ResultSubRow = OC.Include("Service.AuctionScanClasses.ResultSubRow")
local ResultRowWrapper = LibOCClass.DefineClass("ResultRowWrapper")
local private = {
