...
local ResultSubRow = OC.Init("Service.AuctionScanClasses.ResultSubRow") ---@class Service.AuctionScanClasses.ResultSubRow
...
local ResultSubRowWrapper = LibOCClass.DefineClass("ResultSubRowWrapper")
local private = {
