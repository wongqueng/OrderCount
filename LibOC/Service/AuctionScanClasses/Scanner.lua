...
local Scanner = OC.Init("Service.AuctionScanClasses.Scanner") ---@class Service.AuctionScanClasses.Scanner
...
local ResultRow = OC.Include("Service.AuctionScanClasses.ResultRow")
local private = {
	resolveSellers = nil,
	pendingFuture = nil,
	query = nil,
