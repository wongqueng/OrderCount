...
local ExtraTip = OC.Init("Service.ItemTooltipClasses.ExtraTip") ---@class Service.ItemTooltipClasses.ExtraTip
local private = {
	numExtraTips = 0,
}
...
function private.CreateExtraTip(tooltip)
	...
	local extraTip = CreateFrame("GameTooltip", "OCExtraTip"..private.numExtraTips, tooltip, "GameTooltipTemplate")
