...
local Schema = OC.Init("Util.DatabaseClasses.Schema") ---@class Util.DatabaseClasses.Schema
local DBTable = OC.Include("Util.DatabaseClasses.DBTable")
local ObjectPool = OC.Include("Util.ObjectPool")
local LibOCClass = OC.Include("LibOCClass")
local DatabaseSchema = LibOCClass.DefineClass("DatabaseSchema") ---@class DatabaseSchema
local private = {
	objectPool = nil,
}
