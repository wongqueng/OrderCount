...
local QueryClause = OC.Init("Util.DatabaseClasses.QueryClause") ---@class Util.DatabaseClasses.QueryClause
...
local DatabaseQueryClause = LibOCClass.DefineClass("DatabaseQueryClause") ---@class DatabaseQueryClause
local private = {
	objectPool = nil,
}
