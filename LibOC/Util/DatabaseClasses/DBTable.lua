...
local DBTable = OC.Init("Util.DatabaseClasses.DBTable") ---@class Util.DatabaseClasses.DBTable
local Util = OC.Include("Util.DatabaseClasses.Util")
local QueryResultRow = OC.Include("Util.DatabaseClasses.QueryResultRow")
local Query = OC.Include("Util.DatabaseClasses.Query")
...
local DatabaseTable = LibOCClass.DefineClass("DatabaseTable") ---@class DatabaseTable
local private = {
	createCallback = nil,
