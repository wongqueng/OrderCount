...
local Query = OC.Init("Util.DatabaseClasses.Query") ---@class Util.DatabaseClasses.Query
local Constants = OC.Include("Util.DatabaseClasses.Constants")
local Util = OC.Include("Util.DatabaseClasses.Util")
local QueryResultRow = OC.Include("Util.DatabaseClasses.QueryResultRow")
local QueryClause = OC.Include("Util.DatabaseClasses.QueryClause")
...
local DatabaseQuery = LibOCClass.DefineClass("DatabaseQuery") ---@class DatabaseQuery
local private = {
	objectPool = nil,
