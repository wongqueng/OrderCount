...
local Stream = OC.Init("Util.ReactiveClasses.Stream") ---@class Util.ReactiveClasses.Stream
local Publisher = OC.Include("Util.ReactiveClasses.Publisher")
local Table = OC.Include("Util.Table")
local ReactiveStream = OC.Include("LibOCClass").DefineClass("ReactiveStream") ---@class ReactiveStream
