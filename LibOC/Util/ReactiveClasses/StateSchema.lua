...
local StateSchema = OC.Init("Util.ReactiveClasses.StateSchema") ---@class Util.ReactiveClasses.StateSchema
local State = OC.Include("Util.ReactiveClasses.State")
local ReactiveStateSchema = OC.Include("LibOCClass").DefineClass("ReactiveStateSchema") ---@class ReactiveStateSchema
local VALID_TYPES = {
	number = true,
	string = true,
	boolean = true,
