...
local NamedTupleListType = OC.Init("Util.NamedTupleListType") ---@class Util.NamedTupleListType
local private = {}
...
local NamedTupleList = OC.Include("LibOCClass").DefineClass("NamedTupleList") ---@class NamedTupleList
