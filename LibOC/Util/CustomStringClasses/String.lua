...
local String = OC.Init("Util.CustomStringClasses.String") ---@class Util.CustomStringClasses.String
local Tokenizer = OC.Include("Util.CustomStringClasses.Tokenizer")
local AST = OC.Include("Util.CustomStringClasses.AST")
local CodeGen = OC.Include("Util.CustomStringClasses.CodeGen")
local Types = OC.Include("Util.CustomStringClasses.Types")
...
local CustomStringObject = OC.Include("LibOCClass").DefineClass("CustomStringObject") ---@class CustomStringObject
