...
local AST = OC.Init("Util.CustomStringClasses.AST") ---@class Util.CustomStringClasses.AST
local Types = OC.Include("Util.CustomStringClasses.Types")
local Optimizer = OC.Include("Util.CustomStringClasses.Optimizer")
local EnumType = OC.Include("Util.EnumType")
local Money = OC.Include("Util.Money")
local TokenProcessor = OC.Include("LibOCClass").DefineClass("TokenProcessor") ---@class TokenProcessor
local private = {
	tokenProcessor = nil,
	expressionStackTemp = {},
