...
local Types = OC.Init("Util.CustomStringClasses.Types") ---@class Util.CustomStringClasses.Types
local EnumType = OC.Include("Util.EnumType")
local NamedTupleListType = OC.Include("Util.NamedTupleListType")
local TreeType = OC.Include("Util.TreeType")
