...
local CodeGen = OC.Init("Util.CustomStringClasses.CodeGen") ---@class Util.CustomStringClasses.CodeGen
local CustomStringCodeGen = OC.Include("LibOCClass").DefineClass("CustomStringCodeGen") ---@class CustomStringCodeGen
...
local StringBuilder = OC.Include("Util.StringBuilder")
local private = {
	instance = nil,
}
