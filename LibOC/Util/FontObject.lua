...
local FontObject = OC.Init("Util.FontObject") ---@class Util.FontObject
local FontObjectValue = OC.Include("LibOCClass").DefineClass("FontObjectValue") ---@class FontObjectValue
