...
local Color = OC.Init("Util.Color") ---@class Util.Color
local Math = OC.Include("Util.Math")
local HSLuv = OC.Include("Util.HSLuv")
local ColorValue = OC.Include("LibOCClass").DefineClass("ColorValue") ---@class ColorValue
local private = {
	transparent = nil,
	fullWhite = nil,
	fullBlack = nil,
