...
local NineSlice = OC.Init("Util.NineSlice") ---@class Util.NineSlice
local NineSliceTexture = OC.Include("LibOCClass").DefineClass("NineSliceTexture") ---@class NineSliceTexture
local private = {
	styles = {},
}
local PART_ANCHORS = {
