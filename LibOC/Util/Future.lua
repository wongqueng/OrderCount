...
local Future = OC.Init("Util.Future") ---@class Util.Future
local FutureObject = OC.Include("LibOCClass").DefineClass("FutureObject") ---@class FutureObject
...
function FutureObject:GetState()
	return self._state
end
