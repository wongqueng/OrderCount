...
local StringBuilder = OC.Init("Util.StringBuilder") ---@class Util.StringBuilder
local StringBuilderObject = OC.Include("LibOCClass").DefineClass("StringBuilderObject") ---@class StringBuilderObject
local private = {
	instance = nil,
	argsTemp = {},
	argNamesTemp = {},
