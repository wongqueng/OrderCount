...
local Environment = OC.Init("Environment") ---@class Environment
...
local VERSION_RAW = GetAddOnMetadata("OrderCount", "Version")
local IS_DEV_VERSION = strmatch(VERSION_RAW, "^@oc%-project%-version@$") and true or false
