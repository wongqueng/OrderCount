...
L["Adjust how OC values crafted items when calculating profit."] = "調整OC在計算利潤時如何估值製造品。"
...
L["An old OC addon was found installed. Please remove %s and any other old OC addons to avoid issues."] = "發現安裝有舊的OC插件。請刪除%s和任何其他舊的OC插件，以避免出現問題。"
...
L["CRAFTING"] = "製造"
L["CTRL"] = "CTRL"
L["Can't load OC tooltip while in combat"] = "戰鬥中無法載入OC提示"
L["Cancel"] = "取消"
L["Cancel %d / %d"] = "取消 %d / %d"
...
L["Cash Register"] = "收銀臺"
L["Changes to the specified profile (i.e. '/oc profile Default' changes to the 'Default' profile)"] = "切換至指定的配置文件（如：'/oc profile Default' 切換至 'Default' 配置文件）"
L["Character"] = "角色"
L["Chat Tab"] = "聊天標籤"
...
L["Edit"] = "編輯"
L["Edit Post"] = "編輯發佈"
L["Embed OC tooltip"] = "嵌入OC 提示"
L["Empty bags"] = "清空背包"
L["Empty price string."] = "清空價格字串。"
L["Enable OC tooltips"] = "開啟 OC 提示框"
...
L["Hiding the OC Banking UI. Type '/oc bankui' to reopen it."] = "隱藏OC銀行助手,輸入'/oc bankui' 可重新打開。"
L["Hiding the OC Task List UI. Type '/oc tasklist' to reopen it."] = "隱藏OC任務清單。輸入 '/oc tasklist' 可重新打開。"
L["High Bidder"] = "高出價者"
...
L["It appears that you've manually copied your saved variables between accounts which will cause OC's automatic sync'ing to not work. You'll need to undo this, and/or delete the TradeSkillMaster saved variables files on both accounts (with WoW closed) in order to fix this."] = "你似乎在賬號間手動複製了SavedVariables，導致OC的自動同步無法工作。你需要撤銷此更改，並/或 刪除這些賬號的OC SavedVariables來修復此問題（需先關閉魔獸世界）。"
L["Item"] = "物品"
L["Item Class"] = "物品類別"
L["Item Level"] = "物品等級"
...
L["Many commonly-used actions in OC can be added to a macro and bound to your scroll wheel. Use the options below to setup this macro and scroll wheel binding."] = "OC許多動作可以添加巨集並綁定滑鼠滾輪。使用以下選項以創建巨集並綁定滑鼠滾輪。"
L["Map Ping"] = "地圖Ping"
L["Market Value"] = "市值"
...
L["No item specified. Usage: /oc restock_help [ITEM_LINK]"] = "未指定物品。 用法：/oc restock help [物品鏈接]"
L["No posting."] = "無正在發佈。"
...
L["Opens the Destroying frame if there's stuff in your bags to be destroyed."] = "背包有可分解物品時，打開OC分解窗口。"
L["Operation"] = "作業"
L["Operations"] = "作業"
...
L["Some general OC options are below."] = "下面是一些一般OC選項."
L["Some general appearance options are below."] = "下列是一些一般外觀選項."
L["Some general options for the OC tooltip information are below."] = "以下是OC鼠標提示信息一般選項。"
...
L["TOP SALE"] = "最高銷售額"
L["OC %s: What's new"] = "OC %s: 新變化"
L["OC Accounting"] = "OC 會計"
L["OC AuctionDB"] = "OC 拍賣數據庫"
L["OC Auctioning"] = "OC 拍賣"
L["OC Crafting"] = "OC 製造"
L["OC Desktop App Status (%s)"] = "OC桌面程式狀態（%s）"
L["OC General Info"] = "OC 一般資訊"
L["OC Shopping"] = "OC購物"
L["OC Sniper"] = "OC狙擊"
L["OC TASK LIST"] = "OC 任務清單"
L["OC Version Info:"] = "OC 版本資訊："
L["OC can automatically sync data between multiple WoW accounts."] = "OC能自動在多個WoW帳戶間同步資料。"
L["OC detected that you just traded %s to %s in return for %s. Would you like Accounting to store a record of this trade?"] = "OC檢測到您剛剛將%s交易給%s以換取%s。您想讓會計模塊保存這筆交易的記錄嗎？"
L["OC doesn't currently have any AuctionDB pricing data for your realm. We recommend you download the OC Desktop Application from %s to automatically update your AuctionDB data (and auto-backup your OC settings)."] = "OC现無本服AuctionDB。請從%s下載OC程式，更新AuctionDB、自動備份OC設置（限美歐服）。"
L["OC failed to scan some auctions. Please rerun the scan."] = "OC未能掃描有些拍賣。請重新運行掃描。"
...
L["OC is missing important information from the OC Desktop Application. Please ensure the OC Desktop Application is running and is properly configured."] = "OC缺少OC桌面程式的重要訊息。請確保OC桌面程式正在運行且正確配置。"
L["OC is not yet ready to establish a new sync connection. Please try again later."] = "OC尚未準備好建立新的同步連接。請稍後重試。"
L["OC will not undercut any players you add to your whitelist."] = "OC將不會對你白名單中的玩家做削價。"
L["OC4"] = "OC4"
...
L["The 'use smart average for purchase price' setting has been removed from OC and replaced with a new 'SmartAvgBuy' price source. Please update your custom prices appropriately."] = "OC移除了 '智能平均買入價' 設定， 並替換爲新的 '智能平均購入SmartAvgBuy'價格來源。 請恰當的更新你的自定義價格。"
...
L["The TradeSkillMaster_AppHelper addon is installed, but not enabled. OC has enabled it and requires a reload."] = "插件TradeSkillMaster_AppHelper已安裝, 但沒啓用. OC現已啓用它並需要重載。."
...
L["There is no Crafting operation applied to this item's OC group (%s)."] = "沒有製作作業應用到這個物品的OC群組（%s）。"
...
L["This item is not in a OC group."] = "這物品不在OC群組中。"
...
L["Time Frame"] = "時段"
L["Tinker"] = "修理"
L["Toggles the OC Banking UI if either the bank or guild bank is currently open."] = "當銀行或公會銀行打開時，打開銀行助手界面。"
L["Toggles the OC Crafting UI."] = "切換OC製造界面。"
L["Toggles the OC Task List UI"] = "切換OC任務列表界面"
L["Toggles the main OC window"] = "切换OC主窗口"
...
L["Usable Only"] = "僅可用"
L["Usage: /oc price <Item Link> <Custom String>"] = "用法: /oc price <物品連接> <Custom String>"
L["Use the settings below to control which lines are shown in tooltips."] = "使用下列設定決定提示框裡顯示的資訊。"
L["Use this list to manage what cooldowns you'd like OC to ignore from crafting."] = "使用這個列表來管理你希望OC在製造過程中忽略哪些冷卻時間。"
L["Use this list to manage what items you'd like OC to ignore from destroying."] = "使用這個列表來管理你希望OC分解時忽略的物品。"
L["Value"] = "價值"
