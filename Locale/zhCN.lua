...
local Locale = OC.Include("Locale")
...
L["Adjust how OC values crafted items when calculating profit."] = "调整OC在计算利润时如何估值制造品。"
...
L["An old OC addon was found installed. Please remove %s and any other old OC addons to avoid issues."] = "发现已安装旧的OC插件。请删除%s和任何其他旧的OC插件，以避免出现问题。"
...
L["CRAFTING"] = "制造"
L["CTRL"] = "CTRL"
L["Can't load OC tooltip while in combat"] = "战斗中不能载入OC鼠标提示"
L["Cancel"] = "取消"
L["Cancel %d / %d"] = "取消 %d / %d"
...
L["Cash Register"] = "收银台"
L["Changes to the specified profile (i.e. '/oc profile Default' changes to the 'Default' profile)"] = "切换至指定的配置文件（如：'/oc profile Default' 切换至 'Default' 配置文件）"
L["Character"] = "角色"
L["Chat Tab"] = "聊天标签"
...
L["Edit"] = "编辑"
L["Edit Post"] = "编辑发布"
L["Embed OC tooltip"] = "嵌入OC工具提示"
L["Empty bags"] = "空的背包"
L["Empty price string."] = "清空价格字符串。"
L["Enable OC tooltips"] = "启用OC工具提示"
...
L["Hiding the OC Banking UI. Type '/oc bankui' to reopen it."] = "隐藏OC银行助手,输入 '/oc bankui'  可重新打开"
L["Hiding the OC Task List UI. Type '/oc tasklist' to reopen it."] = "隐藏OC 任务列表,输入 '/oc tasklist' 可重新打开"
L["High Bidder"] = "高出价者"
...
L["Hr"] = "小时"
L["Hrs"] = "小时"
L["If enabled, OC will load data (i.e. inventory / Accounting / gold tracking) from every realm you have characters on, instead of just connected realms."] = "If enabled, OC will load data (i.e. inventory / Accounting / gold tracking) from every realm you have characters on, instead of just connected realms."
...
L["In retail, there's a new option in the settings to get OC to make inventory and accounting data available from every realm in your region."] = "In retail, there's a new option in the settings to get OC to make inventory and accounting data available from every realm in your region."
...
L["It appears that you've manually copied your saved variables between accounts which will cause OC's automatic sync'ing to not work. You'll need to undo this, and/or delete the OrderCount saved variables files on both accounts (with WoW closed) in order to fix this."] = "你似乎在账号间手动复制了SavedVariables，导致OC的自动同步无法工作。你需要撤销此更改，并/或 删除这些账号的OC SavedVariables来修复此问题（需先关闭魔兽世界）。"
L["Item"] = "物品"
L["Item Class"] = "物品类别"
L["Item Level"] = "物品等级"
...
L["Looks like OrderCount has encountered an error. Please help the author fix this error by following the instructions shown."] = "看上去OC出错了。请按以下说明来帮助作者修正错误。"
...
L["Many commonly-used actions in OC can be added to a macro and bound to your scroll wheel. Use the options below to setup this macro and scroll wheel binding."] = "OC 中的许多常用操作可以添加到宏并绑定到滚轮。使用下面的选项设置宏和滚轮绑定。"
L["Map Ping"] = "地图Ping"
L["Market Value"] = "市场价格"
...
L["No AuctionDB Realm Data"] = "无OC数据库 服务器数据"
L["No AuctionDB Region Data"] = "无OC数据库 区域数据"
...
L["No item specified. Usage: /oc restock_help [ITEM_LINK]"] = "未指定物品。 用法：/oc restock help [物品链接]"
L["No posting."] = "未发布"
...
L["Only the last 6 months of Accounting purchases and sales data for %s was loaded. Consider clearing old Accounting data from the OC settings on that realm."] = "Only the last 6 months of Accounting purchases and sales data for %s was loaded. Consider clearing old Accounting data from the OC settings on that realm."
...
L["Opens the Destroying frame if there's stuff in your bags to be destroyed."] = "背包有可分解物品，则打开OC分解窗口。"
L["Operation"] = "操作"
L["Operations"] = "操作"
...
L["Restock OC Groups"] = "Restock OC Groups"
L["Restock bags"] = "背包补货"
...
L["Some general OC options are below."] = "以下是一些通用的 OC 选项。"
L["Some general appearance options are below."] = "以下是一些关于外观的选项。"
L["Some general options for the OC tooltip information are below."] = "以下是一些关于 OC 鼠标提示信息的选项。"
...
L["TOP PURCHASE"] = "热门购买"
L["TOP SALE"] = "最畅销"
L["OC %s: What's new"] = "OC %s: 新变化"
L["OC Accounting"] = "OC会计"
L["OC AuctionDB"] = "OC拍卖数据库"
L["OC Auctioning"] = "OC拍卖"
L["OC Crafting"] = "OC制造"
L["OC Desktop App Status (%s)"] = "OC桌面程序状态(%s)"
L["OC General Info"] = "OC 一般信息"
L["OC Shopping"] = "OC购物"
L["OC Sniper"] = "OC狙击"
L["OC TASK LIST"] = "OC 任务列表"
L["OC Version Info:"] = "OC版本信息："
L["OC can automatically sync data between multiple WoW accounts."] = "OC能自动在多个WoW账号间同步数据。"
L["OC detected that you just traded %s to %s in return for %s. Would you like Accounting to store a record of this trade?"] = "OC检测到您刚刚将%s交易给%s以换取%s。您想让会计模块保存这笔交易的记录吗？"
L["OC doesn't currently have any AuctionDB pricing data for your realm. We recommend you download the OC Desktop Application from %s to automatically update your AuctionDB data (and auto-backup your OC settings)."] = "OC现无本服AuctionDB。请从%s下载OC程序，更新AuctionDB、自动备份OC设置（限美欧服）。"
L["OC failed to scan some auctions. Please rerun the scan."] = "OC未能扫描拍卖。 请重新运行扫描。"
L["OC is currently rebuilding its item cache which may cause FPS drops and result in OC not being fully functional until this process is complete. This is normal and typically takes a few minutes."] = "OC is currently rebuilding its item cache which may cause FPS drops and result in OC not being fully functional until this process is complete. This is normal and typically takes a few minutes."
L["OC is missing important information from the OC Desktop Application. Please ensure the OC Desktop Application is running and is properly configured."] = "OC缺少OC桌面程序的重要信息。 请确保OC桌面程序正在运行且正确配置。"
L["OC is not yet ready to establish a new sync connection. Please try again later."] = "OC尚未准备好建立新的同步连接，请稍后重试。"
L["OC will not undercut any players you add to your whitelist."] = "OC将不会试图压价你白名单中角色发布的物品。"
L["OC4"] = "OC4"
...
L["The 'use smart average for purchase price' setting has been removed from OC and replaced with a new 'SmartAvgBuy' price source. Please update your custom prices appropriately."] = "使用“智能平均买入价”设置已经从OC移除，并且被新的“智能平均购入”价格源取代。请更新您的自定义价格。"
...
L["The OrderCount_AppHelper addon is installed, but not enabled. OC has enabled it and requires a reload."] = "OrderCount_AppHelper插件已安装，但未启用。OC现启用它，需要重新加载。"
...
L["There is no Crafting operation applied to this item's OC group (%s)."] = "没有对该物品的OC分组（%s）应用任何制造操作。"
...
L["This item is not in a OC group."] = "此物品不在OC分组"
...
L["Time Frame"] = "时限"
L["Tinker"] = "修理"
L["Toggles the OC Banking UI if either the bank or guild bank is currently open."] = "当银行或公会银行打开时，打开OC银行助手界面。"
L["Toggles the OC Crafting UI."] = "切换OC制造UI"
L["Toggles the OC Task List UI"] = "切换 OC 任务列表 UI"
L["Toggles the main OC window"] = "切換OC主窗口"
...
L["Usable Only"] = "仅可用"
L["Usage: /oc price <Item Link> <Custom String>"] = "用法: /oc price <Item Link> <Custom String>"
L["Use the settings below to control which lines are shown in tooltips."] = "以下设定用来控制鼠标提示显示的行。"
L["Use this list to manage what cooldowns you'd like OC to ignore from crafting."] = "使用这个列表来管理你希望OC在制造过程中忽略哪些冷却时间"
L["Use this list to manage what items you'd like OC to ignore from destroying."] = "使用此列表来管理您不希望OC分解的物品。"
L["Value"] = "价值"
