...
local Shopping = OC.Operations:NewPackage("Shopping")
...
function Shopping.OnInitialize()
	...
	OC.Operations.Register("Shopping", L["Shopping"], OPERATION_INFO, 1, private.GetOperationInfo)
end
...
function private.GetOperationSettings(itemString)
	...
	local operationName, operationSettings = OC.Operations.GetFirstOperationByItem("Shopping", itemString)
