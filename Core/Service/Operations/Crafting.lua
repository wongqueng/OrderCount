...
local Crafting = OC.Operations:NewPackage("Crafting")
...
function Crafting.OnInitialize()
	OC.Operations.Register("Crafting", L["Crafting"], OPERATION_INFO, 1, private.GetOperationInfo)
	for _, name in OC.Operations.OperationIterator("Crafting") do
		local operation = OC.Operations.GetSettings("Crafting", name)
...
function Crafting.IsValid(itemString)
	...
	local operationName, operationSettings = OC.Operations.GetFirstOperationByItem("Crafting", itemString)
