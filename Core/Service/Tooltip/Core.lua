...
local Tooltip = OC:NewPackage("Tooltip")
local ItemString = OC.Include("Util.ItemString")
local ObjectPool = OC.Include("Util.ObjectPool")
local ItemTooltip = OC.Include("Service.ItemTooltip")
local Settings = OC.Include("Service.Settings")
local LibOCClass = OC.Include("LibOCClass")
local TooltipInfo = LibOCClass.DefineClass("TooltipInfo")
local TooltipEntry = LibOCClass.DefineClass("TooltipEntry")
local private = {
