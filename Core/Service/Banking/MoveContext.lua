...
local MoveContext = OC.Banking:NewPackage("MoveContext")
...
local BaseMoveContext = OC.Include("LibOCClass").DefineClass("BaseMoveContext", nil, "ABSTRACT")
...
local BagToBankMoveContext = OC.Include("LibOCClass").DefineClass("BagToBankMoveContext", BaseMoveContext)
...
local BankToBagMoveContext = OC.Include("LibOCClass").DefineClass("BankToBagMoveContext", BaseMoveContext)
...
local BagToGuildBankMoveContext = OC.Include("LibOCClass").DefineClass("BagToGuildBankMoveContext", BaseMoveContext)
...
local GuildBankToBagMoveContext = OC.Include("LibOCClass").DefineClass("GuildBankToBagMoveContext", BaseMoveContext)
