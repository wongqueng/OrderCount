...
OC:NewPackage("Shopping")
local Threading = OC.Include("Service.Threading")
local ShoppingSearchContext = OC.Include("LibOCClass").DefineClass("ShoppingSearchContext")
OC.Shopping.ShoppingSearchContext = ShoppingSearchContext
