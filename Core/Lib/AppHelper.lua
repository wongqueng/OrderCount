...
local AppHelper = OC:NewPackage("AppHelper")
local Environment = OC.Include("Environment")
local ClassicRealms = OC.Include("Data.ClassicRealms")
...
function OC_APPHELPER_LOAD_DATA(tag, realmOrRegion, data)
