...
function EditableText:__init()
	...
	frame:OCSetScript("OnEscapePressed", self:__closure("_HandleEscapePressed"))
	frame:OCSetScript("OnEnterPressed", self:__closure("_HandleEnterPressed"))
	frame:OCSetScript("OnEditFocusLost", self:__closure("_HandleEditFocusLost"))
...
function EditableText:Acquire()
	...
	self._state:PublisherForKeyChange("color")
		:CallMethod(frame, "OCSubscribeTextColor")
	...
	self._state:PublisherForKeyChange("editing")
		:InvertBoolean()
		:CallMethod(frame.text, "OCSetShown")
	...
	self._state:PublisherForKeyChange("editing")
		:CallMethod(frame, "OCSetFocused")
	self._state:PublisherForKeyChange("editing")
		:CallMethod(frame, "OCSetAllHighlighted")
end
