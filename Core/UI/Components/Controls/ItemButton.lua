...
function ItemButton:__init()
	...
	self._highlight:OCSetTextureAndCoord(HIGHLIGHT_TEXTURE)
	...
	self._icon:OCSubscribeColorTexture("INDICATOR_ALT")

	self._quality = UIElements.CreateFontString(self, frame)
	self._quality:SetSize(20, 20)
	self._quality:OCSetFont("BODY_BODY2")
...
function ItemButton:Acquire()
	...
	self._state:PublisherForKeyChange("itemString")
		...
		:CallMethod(self._icon, "OCSetTextureAndCoord")
