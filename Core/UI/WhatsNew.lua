...
local WhatsNew = OC.UI:NewPackage("WhatsNew")
...
local CONTENT_LINES = {
	Theme.GetColor("INDICATOR"):ColorText(L["Retail Region-Wide Tracking"]).." "..L["In retail, there's a new option in the settings to get OC to make inventory and accounting data available from every realm in your region."],
	...
	return UIElements.New("Frame", "whatsnew")
		...
		:AddChild(UIElements.New("Frame", "header")
			...
			:AddChild(UIElements.New("Text", "title")
				...
				:SetFormattedText(L["OC %s: What's new"], "4.13")
			)
