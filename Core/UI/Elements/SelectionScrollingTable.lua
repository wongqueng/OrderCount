...
local SelectionScrollingTable = OC.Include("LibOCClass").DefineClass("SelectionScrollingTable", OC.UI.QueryScrollingTable)
UIElements.Register(SelectionScrollingTable)
OC.UI.SelectionScrollingTable = SelectionScrollingTable
local private = {
