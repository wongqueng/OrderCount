...
local AuctionScrollingTable = OC.Include("LibOCClass").DefineClass("AuctionScrollingTable", OC.UI.ScrollingTable)
local UIElements = OC.Include("UI.UIElements")
UIElements.Register(AuctionScrollingTable)
OC.UI.AuctionScrollingTable = AuctionScrollingTable
local private = {
	sortContext = {
		rowSortValue = {},
		baseSortValue = {},
