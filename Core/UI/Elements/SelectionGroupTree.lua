...
local SelectionGroupTree = OC.Include("LibOCClass").DefineClass("SelectionGroupTree", OC.UI.GroupTree)
UIElements.Register(SelectionGroupTree)
OC.UI.SelectionGroupTree = SelectionGroupTree
...
function SelectionGroupTree.__init(self)
	...
	self._selectedGroup = OC.CONST.ROOT_GROUP_PATH
