...
local QueryScrollingTable = OC.Include("LibOCClass").DefineClass("QueryScrollingTable", OC.UI.ScrollingTable)
...
OC.UI.QueryScrollingTable = QueryScrollingTable
...
function QueryScrollingTable._CreateScrollingTableInfo(self)
	return OC.UI.Util.QueryScrollingTableInfo()
end
