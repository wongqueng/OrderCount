...
local ScrollFrame = OC.Include("LibOCClass").DefineClass("ScrollFrame", OC.UI.Container)
local UIElements = OC.Include("UI.UIElements")
UIElements.Register(ScrollFrame)
OC.UI.ScrollFrame = ScrollFrame
local private = {}
...
function ScrollFrame.Draw(self)
	...
	self._scrollbar.thumb:SetHeight(OC.UI.Scrollbar.GetLength(totalHeight, self:_GetDimension("HEIGHT")))
