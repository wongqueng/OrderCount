...
local OverlayApplicationFrame = OC.Include("LibOCClass").DefineClass("OverlayApplicationFrame", OC.UI.Frame)
UIElements.Register(OverlayApplicationFrame)
OC.UI.OverlayApplicationFrame = OverlayApplicationFrame
local private = {}
