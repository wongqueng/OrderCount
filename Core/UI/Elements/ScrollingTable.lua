...
local ScrollingTable = OC.Include("LibOCClass").DefineClass("ScrollingTable", OC.UI.Element, "ABSTRACT")
local UIElements = OC.Include("UI.UIElements")
UIElements.Register(ScrollingTable)
OC.UI.ScrollingTable = ScrollingTable
local private = {
	rowPool = ObjectPool.New("TABLE_ROWS", OC.UI.Util.TableRow, 1),
}
...
function ScrollingTable._CreateScrollingTableInfo(self)
	return OC.UI.Util.ScrollingTableInfo()
end
