...
local MyAuctionsScrollingTable = OC.Include("LibOCClass").DefineClass("MyAuctionsScrollingTable", OC.UI.QueryScrollingTable)
...
OC.UI.MyAuctionsScrollingTable = MyAuctionsScrollingTable
