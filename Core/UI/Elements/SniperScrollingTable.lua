...
local SniperScrollingTable = OC.Include("LibOCClass").DefineClass("SniperScrollingTable", OC.UI.AuctionScrollingTable)
local UIElements = OC.Include("UI.UIElements")
UIElements.Register(SniperScrollingTable)
OC.UI.SniperScrollingTable = SniperScrollingTable
local private = {}
