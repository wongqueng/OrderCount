...
local ScrollingTableInfo = OC.Include("LibOCClass").DefineClass("ScrollingTableInfo")
local ScrollingTableColumnInfo = OC.Include("LibOCClass").DefineClass("ScrollingTableColumnInfo")
OC.UI.Util.ScrollingTableInfo = ScrollingTableInfo
OC.UI.Util.ScrollingTableColumnInfo = ScrollingTableColumnInfo
