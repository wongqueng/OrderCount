...
local QueryScrollingTableInfo = OC.Include("LibOCClass").DefineClass("QueryScrollingTableInfo", OC.UI.Util.ScrollingTableInfo)
local QueryScrollingTableColumnInfo = OC.Include("LibOCClass").DefineClass("QueryScrollingTableColumnInfo", OC.UI.Util.ScrollingTableColumnInfo)
OC.UI.Util.QueryScrollingTableInfo = QueryScrollingTableInfo
