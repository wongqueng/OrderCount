...
local TexturePacks = OC.UI:NewPackage("TexturePacks")
...
local TEXTURE_FILE_INFO = {
	uiFrames = {
		path = "Interface\\Addons\\OrderCount\\Media\\UIFrames.tga",
		scale = 1,
		width = 512,
		height = 512,
		coord = {
	...
	iconPack = {
		path = "Interface\\Addons\\OrderCount\\Media\\IconPack.tga",
		scale = 1,
		width = 256,
		height = 256,
		coord = {
