...
local Auctioning = OC.MainUI.Settings:NewPackage("Auctioning")
...
function Auctioning.OnInitialize()
	...
	OC.MainUI.Settings.RegisterSettingPage(L["Auctioning"], "middle", private.GetAuctioningSettingsFrame)
...
function private.GetAuctioningSettingsFrame()
	...
	return UIElements.New("ScrollFrame", "auctioningSettings")
		:SetPadding(8, 8, 8, 0)
		:AddChild(OC.MainUI.Settings.CreateExpandableSection("Auctioning", "auctioning", L["General Options"], L["Some general Auctioning options are below."])
		...
		:AddChild(OC.MainUI.Settings.CreateExpandableSection("Auctioning", "sounds", L["Auction House Sounds"], L["Setup various sounds that play when doing Auctioning scans."])
...
function private.AddWhitelistSettings(frame)
	...
	frame:AddChild(OC.MainUI.Settings.CreateExpandableSection("Auctioning", "whitelist", L["Whitelist"], L["OC will not undercut any players you add to your whitelist."])
