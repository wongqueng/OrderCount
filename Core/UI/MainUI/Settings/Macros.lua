...
local Macros = OC.MainUI.Settings:NewPackage("Macros")
...
local BUTTON_INFO = {
	["row1.myauctionsCheckbox"] = {name = "OCCancelAuctionBtn"},
	["row1.auctioningCheckbox"] = {name = "OCAuctioningBtn"},
	["row2.shoppingCheckbox"] = {name = "OCShoppingBuyoutBtn"},
	["row2.bidBuyConfirmBtn"] = {name = "OCBidBuyConfirmBtn"},
	["row3.sniperCheckbox"] = {name = "OCSniperBtn"},
	["row3.craftingCheckbox"] = {name = "OCCraftingBtn"},
	["row4.destroyingCheckbox"] = {name = "OCDestroyBtn", button = Environment.IsRetail() and "LeftButton "..buttonEvent or nil},
	["row4.vendoringCheckbox"] = {name = "OCVendoringSellAllButton"},
}
...
function Macros.OnInitialize()
	OC.MainUI.Settings.RegisterSettingPage(L["Macros"], "middle", private.GetMacrosSettingsFrame)
end
...
function private.GetMacrosSettingsFrame()
	...
	local frame = UIElements.New("ScrollFrame", "macroSettings")
		:SetPadding(8, 8, 8, 0)
		:AddChild(OC.MainUI.Settings.CreateExpandableSection("Macro", "setup", L["Macro Setup"], L["Many commonly-used actions in OC can be added to a macro and bound to your scroll wheel. Use the options below to setup this macro and scroll wheel binding."], 40)
