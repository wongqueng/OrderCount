...
local Mailing = OC.MainUI.Settings:NewPackage("Mailing")
...
function Mailing.OnInitialize()
	OC.MainUI.Settings.RegisterSettingPage(L["Mailing"], "middle", private.GetMailingSettingsFrame)
...
function private.GetMailingSettingsFrame()
	...
	return UIElements.New("ScrollFrame", "mailingSettings")
		:SetPadding(8, 8, 8, 0)
		:AddChild(OC.MainUI.Settings.CreateExpandableSection("Mailing", "inbox", L["Inbox Settings"], "")
			:AddChild(UIElements.New("Frame", "content")
				...
				:AddChild(UIElements.New("Checkbox", "inboxMessagesCheckbox")
					...
					:SetSettingInfo(OC.db.global.mailingOptions, "inboxMessages")
				)
			...
			:AddChild(UIElements.New("Frame", "freeSpaceFrame")
				...
				:AddChild(UIElements.New("Input", "keepMailInput")
					...
					:SetSettingInfo(OC.db.global.mailingOptions, "keepMailSpace")
				)
				:AddChild(UIElements.New("Text", "label")
					:SetSize("AUTO", 16)
					:SetFont("BODY_BODY3")
			...
			:AddChild(UIElements.New("SelectionDropdown", "soundDropdown")
				...
				:SetSettingInfo(OC.db.global.mailingOptions, "openMailSound")
				:SetScript("OnSelectionChanged", private.SoundOnSelectionChanged)
			)
		)
		:AddChild(OC.MainUI.Settings.CreateExpandableSection("Mailing", "send", L["Sending Settings"], "")
			:AddChild(UIElements.New("Frame", "check1")
				...
				:AddChild(UIElements.New("Checkbox", "sendMessagesCheckbox")
					...
					:SetSettingInfo(OC.db.global.mailingOptions, "sendMessages")
				)
				:AddChild(UIElements.New("Spacer", "spacer"))
			)
			:AddChild(UIElements.New("Frame", "check2")
				...
				:AddChild(UIElements.New("Checkbox", "sendItemsCheckbox")
					...
					:SetSettingInfo(OC.db.global.mailingOptions, "sendItemsIndividually")
				)
				:AddChild(UIElements.New("Spacer", "spacer"))
			)
			:AddChild(UIElements.New("Text", "label")
			...
			:AddChild(UIElements.New("Frame", "restartDelayFrame")
				...
				:AddChild(UIElements.New("Input", "restartDelay")
					...
					:SetValue(OC.db.global.mailingOptions.resendDelay)
			...
			:AddChild(UIElements.New("SelectionDropdown", "mailPageDropdown")
				...
				:SetSettingInfo(OC.db.global.mailingOptions, "deMaxQuality")
			)
		)
end
...
function private.SoundOnSelectionChanged(self, selection)
	Sound.PlaySound(OC.db.global.mailingOptions.openMailSound)
end

function private.RestartDelayOnValueChanged(input)
	local value = Math.Round(tonumber(input:GetValue()), 0.5)
	OC.db.global.mailingOptions.resendDelay = value
end
