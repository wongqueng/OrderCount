...
local Auctions = OC.MainUI.Ledger.Common:NewPackage("Auctions")
...
function Auctions.OnInitialize()
	...
	OC.MainUI.Ledger.FailedAuctions.RegisterPage(L["Expired"], private.DrawExpiredPage)
	OC.MainUI.Ledger.FailedAuctions.RegisterPage(L["Cancelled"], private.DrawCancelledPage)
end
...
function private.DrawAuctionsPage()
	private.query = private.query or OC.Accounting.Auctions.CreateQuery()
