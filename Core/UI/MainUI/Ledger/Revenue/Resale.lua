...
local Resale = OC.MainUI.Ledger.Revenue:NewPackage("Resale")
...
function Resale.OnInitialize()
	...
	OC.MainUI.Ledger.Revenue.RegisterPage(L["Resale"], private.DrawResalePage)
end
...
function private.DrawResalePage()
	...
	OC.Accounting.Transactions.GetCharacters(private.characters)
	for _, character in ipairs(private.characters) do
		private.characterFilter[character] = true
	end

	private.summaryQuery = private.summaryQuery or OC.Accounting.Transactions.CreateSummaryQuery()
...
function private.UpdateQuery()
	...
	OC.Accounting.Transactions.UpdateSummaryData(groupFilter, searchFilter, typeFilter, characterFilter, minTime)
