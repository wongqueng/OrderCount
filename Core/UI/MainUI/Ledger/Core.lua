...
local Ledger = OC.MainUI:NewPackage("Ledger")
...
function Ledger.OnInitialize()
	...
	OC.MainUI.RegisterTopLevelPage(L["Ledger"], private.GetLedgerFrame)
end
			...
			:AddChild(UIElements.New("Frame", "content")
				...
				:AddChild(UIElements.New("Frame", "quantity")
					...
					:AddChild(UIElements.New("Text", "total")
						...
						:SetJustifyH("RIGHT")
						:SetText(OC.Accounting.Transactions.GetQuantity(private.contextItemString, nil, private.itemDetailType))
					)
					:AddChild(UIElements.New("Text", "last7")
						:SetWidth(120)
						:SetMargin(0, 8, 0, 0)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(OC.Accounting.Transactions.GetQuantity(private.contextItemString, SECONDS_PER_DAY * 7, private.itemDetailType))
					)
					:AddChild(UIElements.New("Text", "last30")
						:SetWidth(120)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(OC.Accounting.Transactions.GetQuantity(private.contextItemString, SECONDS_PER_DAY * 30, private.itemDetailType))
					)
				)
				:AddChild(UIElements.New("Frame", "avgPrice")
					...
					:AddChild(UIElements.New("Text", "total")
						...
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetAveragePrice(private.contextItemString, nil, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
					:AddChild(UIElements.New("Text", "last7")
						:SetWidth(120)
						:SetMargin(0, 8, 0, 0)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 7, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
					:AddChild(UIElements.New("Text", "last30")
						:SetWidth(120)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetAveragePrice(private.contextItemString, SECONDS_PER_DAY * 30, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
				)
				:AddChild(UIElements.New("Frame", "totalPrice")
					...
					:AddChild(UIElements.New("Text", "total")
						...
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetTotalPrice(private.contextItemString, nil, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
					:AddChild(UIElements.New("Text", "last7")
						:SetWidth(120)
						:SetMargin(0, 8, 0, 0)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 7, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
					:AddChild(UIElements.New("Text", "last30")
						:SetWidth(120)
						:SetFont("TABLE_TABLE1")
						:SetJustifyH("RIGHT")
						:SetText(Money.ToString(OC.Accounting.Transactions.GetTotalPrice(private.contextItemString, SECONDS_PER_DAY * 30, private.itemDetailType), nil, "OPT_RETAIL_ROUND"))
					)
				)
				:AddChild(UIElements.New("Frame", "top")
					:SetLayout("HORIZONTAL")
...
function private.ItemDetailScrollingTableOnRowClick(scrollingTable, row, button)
	if button ~= "RightButton" then
		return
	elseif not OC.Accounting.Transactions.CanDeleteByUUID(row:GetUUID()) then
...
function private.DeleteRecordConfirmed(uuid)
	OC.Accounting.Transactions.RemoveRowByUUID(uuid)
end
